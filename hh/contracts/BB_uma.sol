...
contract BiggerBrother {
    ...
    function addNewEvidence(bytes32 pCID, bytes32 eCID) public {
        ...
        string assertionString = string.concat(
            "The following evidence is true for the politician. IPFS hashes: [Politician: ",
            pCIDString,
            "] [Evidence: ",
            eCIDString,
            "]."
    ...
    function settleAndGetAssertionResult(
        ...
        bytes32 assertionId = politicianToEvidenceMapping[pCID][eCID]
            .assertionId;
        politicianToEvidenceMapping[pCID][eCID].uma_status = oov3
            .settleAndGetAssertionResult(assertionId);
    }
}
